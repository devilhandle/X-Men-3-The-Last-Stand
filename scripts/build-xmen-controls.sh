...
# Position the controls relative to the bottom of the game viewport, not the
# top of the Android window. This reproduces the supplied portrait layout.
