...
public class StandaloneLauncherActivity extends Activity {
    ...
    protected void onCreate(Bundle state) {
        ...
        try {
            ...
            profile.vkType = 7; // standalone X-Men layout; do not use normal J2ME layouts
            profile.vkButtonShape = 0; // circular buttons, matching the supplied keypad
            profile.vkAlpha = 225;
            profile.vkForceOpacity = false;
            profile.vkBgColor = 0x4A7F82;
            profile.vkBgColorSelected = 0x679EA1;
            profile.vkFgColor = 0x062C3F;
            profile.vkFgColorSelected = 0xFFFFFF;
            profile.vkOutlineColor = 0x8CB9BC;
